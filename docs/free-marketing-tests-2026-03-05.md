# Free Marketing Tests — 2026-03-05

Goal: maximize **site visits -> App Store clicks -> installs/subscriptions** with free checks only.

Overall pass rate: **43/50 (86.0%)**

## Page checks
| Page | HTTP | TTFB(s) | Total(s) | Title | Desc | H1 | AppStore link | Schema | Noindex | Tracking |
|---|---:|---:|---:|---:|---:|:--:|:--:|:--:|:--:|:--:|
| `/` | 200 | 0.10 | 0.10 | 42 | 171 | ✅ | ✅ (7) | ✅ | ✅ | ✅ |
| `/shotsy-alternative.html` | 200 | 0.09 | 0.09 | 67 | 140 | ✅ | ✅ (2) | ❌ | ✅ | ✅ |
| `/glp1-injection-tracker.html` | 200 | 0.09 | 0.09 | 69 | 129 | ✅ | ✅ (2) | ❌ | ✅ | ✅ |
| `/zepbound-injection-tracker.html` | 200 | 0.09 | 0.09 | 72 | 127 | ✅ | ✅ (2) | ✅ | ✅ | ✅ |
| `/guides/` | 200 | 0.10 | 0.11 | 43 | 188 | ✅ | ✅ (4) | ❌ | ✅ | ✅ |
